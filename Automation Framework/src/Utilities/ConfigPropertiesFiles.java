...
public class ConfigPropertiesFiles extends JXlKeywords{
	...
	public static void createPropertiesFiles() {
		...
		List<String> urls=new ArrayList<String>(browserNo);
		...
		JXlKeywords dd = new JXlKeywords();
			...
			properties.store(new FileOutputStream(
					"./config/FrameworkConfiguration.properties"), null);
			dd.w.close();
			...
			{								
				...
				parameter4.setAttribute("value", getFrameworkConfigProperty("URL"));
				...
				parameter6.setAttribute("value", browserVersionName.get(brow-1).toString());
				...
				parameter9.setAttribute("name", "selenium.url");
				parameter9.setAttribute("value", urls.get(brow-1).toString());
				...
				dd.useExcelSheet(CommonFrameworkKeywords.getFrameworkConfigProperty("Tc_Settings_Excelpath"),0);
